--
-- gdp.ProtobufSingleKafka.sql
--
DROP TABLE IF EXISTS gdp.ProtobufSingleKafka;

CREATE TABLE IF NOT EXISTS gdp.ProtobufSingleKafka (
...
-- SHOW CREATE TABLE gdp.ProtobufSingleKafka;
-- SELECT * FROM gdp.ProtobufSingleKafka LIMIT 20;

-- SELECT
--   count(DISTINCT Poll_Counter)
-- FROM gdp.ProtobufSingleKafka;
