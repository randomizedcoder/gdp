--
-- gdp.ProtobufListKafkaProtodelim.sql
--
...
-- SHOW CREATE TABLE gdp.ProtobufListKafkaProtodelim;
-- SELECT * FROM gdp.ProtobufListKafkaProtodelim LIMIT 20;

-- SELECT
--   count(DISTINCT Poll_Counter)
-- FROM gdp.ProtobufListKafkaProtodelim;
