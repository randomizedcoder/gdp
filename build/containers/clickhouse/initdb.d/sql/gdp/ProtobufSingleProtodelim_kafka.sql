--
-- gdp.ProtobufSingleProtodelim_kafka.sql
--
DROP TABLE IF EXISTS gdp.ProtobufSingleProtodelim_kafka;

CREATE TABLE IF NOT EXISTS gdp.ProtobufSingleProtodelim_kafka (
...
ENGINE = Kafka SETTINGS
  ...
  kafka_topic_list = 'ProtobufSingleProtodelim',
  kafka_group_name = 'ProtobufSingleProtodelim',
  kafka_schema = 'prometheus_protolist.proto:PromRecordCounter',
  kafka_handle_error_mode = 'stream',
  kafka_poll_max_batch_size = 10,
  kafka_format = 'ProtobufSingle';

-- SHOW CREATE TABLE gdp.ProtobufSingleProtodelim_kafka;
-- SELECT * FROM system.kafka_consumers FORMAT Vertical;
-- SELECT * FROM system.kafka_consumers WHERE table LIKE '%gdp.ProtobufSingleProtodelim_kafka%' FORMAT Vertical;
-- DETACH TABLE gdp.ProtobufSingleProtodelim_kafka;
-- SELECT * FROM gdp.ProtobufSingleProtodelim_kafka LIMIT 20;
