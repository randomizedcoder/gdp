...
var file_prometheus_v1_prometheus_protolist_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_prometheus_v1_prometheus_protolist_proto_goTypes = []any{
	(*Envelope)(nil),                   // 0: prometheus.v1.Envelope
	(*Envelope_PromRecordCounter)(nil), // 1: prometheus.v1.Envelope.PromRecordCounter
}
var file_prometheus_v1_prometheus_protolist_proto_depIdxs = []int32{
	1, // 0: prometheus.v1.Envelope.rows:type_name -> prometheus.v1.Envelope.PromRecordCounter
