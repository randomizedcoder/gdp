...
const file_gdp_config_v1_gdp_config_proto_rawDesc = "" +
	...
	"\xc8\x01\x01*\x05\x18\x90N(\x00R\bschemaID\x12(\n" +
	"\bfilename\x182 \x01(\tB\f\xbaH\t\xc8\x01\x01r\x04\x10\x01\x18PR\bfilename\x12\"\n" +
	"\x05topic\x18< \x01(\tB\f\xbaH\t\xc8\x01\x01r\x04\x10\x01\x18PR\x05topicB\x86\x01\n" +
